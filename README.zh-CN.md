...
- **把多工具历史放进一个工作台**：Claude Code、Codex CLI、Antigravity、Kimi Code、Cursor CLI、OpenCode、CC-Mirror、Pi、Grok Build、DSH（DeepSeek Harness）、MiniMax Code 和 GitHub Copilot（CLI + VS Code agent）。
...
SessionView 当前读取 Claude Code、Codex CLI、Antigravity、Kimi Code、Cursor CLI、OpenCode、CC-Mirror、Pi、Grok Build、DSH（DeepSeek Harness）、MiniMax Code 和 GitHub Copilot（CLI + VS Code agent）的本地历史。
