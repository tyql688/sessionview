...
- **Browse one workspace across tools**: Claude Code, Codex CLI, Antigravity, Kimi Code, Cursor CLI, OpenCode, CC-Mirror, Pi, Grok Build, and DSH (DeepSeek Harness).
...
SessionView currently reads local history from Claude Code, Codex CLI, Antigravity, Kimi Code, Cursor CLI, OpenCode, CC-Mirror, Pi, Grok Build, and DSH (DeepSeek Harness).
