...
- **Browse one workspace across tools**: Claude Code, Codex CLI, Antigravity, Kimi Code, Cursor CLI, OpenCode, CC-Mirror, Pi, Grok Build, DSH (DeepSeek Harness), and MiniMax Code.
...
SessionView currently reads local history from Claude Code, Codex CLI, Antigravity, Kimi Code, Cursor CLI, OpenCode, CC-Mirror, Pi, Grok Build, DSH (DeepSeek Harness), and MiniMax Code.
